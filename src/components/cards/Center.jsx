  ...
  return (
    <>
      <div className="">
        ...
        <section className="ml-10 mr-10 p-7 bg-white dark:bg-gray-600  rounded-xl shadow-lg ">
          <div className="font-semibold text-xl bg-gray-200 dark:bg-gray-600  p-2 rounded-xl">
            {" "}
